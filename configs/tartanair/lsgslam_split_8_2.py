...
end_idx = int(os.environ.get("TARTANAIR_END", "-1"))
...
group_name = os.environ.get("LSG_WORKDIR", "experiments/tartanair_split")
if end_idx == -1:
    run_name = f"{scene_name}_full_split5"
else:
    run_name = f"{scene_name}_{start_idx}_{end_idx}_{stride}_split5"
