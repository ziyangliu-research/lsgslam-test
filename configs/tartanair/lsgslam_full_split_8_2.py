...
scene_name = os.environ.get("TARTANAIR_SEQUENCE", "SH000")
start_idx = int(os.environ.get("TARTANAIR_START", "0"))
end_idx = int(os.environ.get("TARTANAIR_END", "199"))
...
group_name = os.environ.get("LSG_WORKDIR", "experiments/tartanair_official_full_split")
# Keep the released folder naming convention because the pose-graph backend
# parses start/end/stride from the final three underscore-separated fields.
