...
seq_dir = os.environ.get(
    "ETH3D_SEQ_DIR",
    f"/home/shiyo/Desktop/Datasets/ETH3D_rectified/{scene_name}",
)
workdir = os.environ.get("LSG_WORKDIR", "experiments/eth3d_full_split_final4")

with open(os.path.join(seq_dir, "calibration.json"), "r", encoding="utf-8") as f:
    calibration = json.load(f)
image_width, image_height = [int(v) for v in calibration["rectified_size"]]
...
start_idx = int(os.environ.get("ETH3D_START", "0"))
end_idx = int(os.environ.get("ETH3D_END", "-1"))
stride = int(os.environ.get("ETH3D_STRIDE", "1"))
