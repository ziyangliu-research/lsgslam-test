...
for sequence in sequences:
    ...
    save_pcd_path=os.path.join(parent_folder, sequence, "3dgs_input/initialize_pcd.pcd")
    ...
    all_pts = []
    img_bar = tqdm(range(0, len(image_files), step))
    for image_file in image_files[::step]:
